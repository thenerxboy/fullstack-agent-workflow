...
- **Phase 1 (Feature-by-Feature Stack Decomposition)**: Extracts every V1 feature from `SYSTEM-PRD.md` (or `ARCH-PRD.md`) and maps exact npm dependencies, surface targets, selection rationales, integration strategies, and step-by-step implementation logic into `docs/03-tech-stack/project-features.md` (fallback `app-features.md`).
- **Phase 2 (8 Sequential Infrastructure Layers)**: Guides you through 8 architectural layers quoting `SYSTEM-PRD.md` and asking 1–2 specific questions per layer.
...
- **Dual-Artifact Delivery**: Generates both `docs/03-tech-stack/project-features.md` and `docs/03-tech-stack/TECH-STACK.md`.
